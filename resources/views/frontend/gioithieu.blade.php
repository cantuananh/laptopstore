...
<div class="container">
    <div id="content">
        <h2 class="text-center wow fadeInDownwow fadeInDown">Laptop Đào Quang</h2>
        <div class="space20">&nbsp;</div>
        <h5 class="text-center other-title wow fadeInLeft">Người quản lý</h5>
        <p class="text-center wow fadeInRight">Đào Văn Quang</p>
        <div class="space20">&nbsp;</div>
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    ...
                    <div class="media-body beta-person-body">
                        ...
                        <p>Luôn cập nhật những mẫu Laptop mới nhất</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    ...
                    <div class="media-body beta-person-body">
                        ...
                        <p>Chúng tôi luôn quan tâm tới nhu cầu của khách hàng</p>
                    </div>
                </div>
            </div>
        </div>
