                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price" style="font-size: 18px">
                                                    <span
                                                        class="flash-del">{{number_format($sp->price*1.1)}}<u>đ</u></span>
                                                    <span
                                    ...
                                    <div class="col-sm-4">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price" style="font-size: 18px">
                                                    <span
                                                        class="flash-del">{{number_format($spkhac->price*1.1)}}<u>đ</u></span>
                                                    <span
                                            ...
                                            <div class="single-item-caption">
                                                ...
                                                <a class="beta-btn primary"
                                                   href="{{route('chitietsanpham',$spkhac->id)}}">Details <i
