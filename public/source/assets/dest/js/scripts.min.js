!function (a) {
    a.fn.betaSelect = function (b) {
        ...
        return this.each(function () {
            var b = a(this), c = b.wrap("<div class='beta-select " + d.class + "'></div>").closest(".beta-select");
    ...
    a.prototype = {
        init: function () {
            ...
            dug({
                ...
                cacheExpire: 3600,
                template: '<a href="{{link}}" target="_blank"><img src="{{images.low_resolution.url}}"></a>'
            })
        }, initFilter: function () {
            ...
            jQuery.fn.roundabout && jQuery(".beta-roundabout").roundabout({responsive: !0})
        }, initCircliful: function () {
            if (jQuery.fn.circliful) {
                var a = window.matchMedia("(max-width: 1200px)"), b = window.matchMedia("(max-width: 993px)"),
            ...
            jQuery(".progress-bar").each(function (a, b) {
                var c = jQuery(b).attr("aria-valuenow"), d = parseInt(c) / 100 * 5e3;
                jQuery(b).animate({width: c + "%"}, d)
            })
        }, initSlider: function () {
            jQuery(".beta-slider").each(function (a, b) {
                var c = jQuery(b), d = c.find(".beta-slider-items"), e = c.find(".beta-arrow-right"),
                    f = c.find(".beta-arrow-left"), g = c.find(".beta-pager"), h = c.find(".beta-pager-gallery"),
            ...
            jQuery(".history-slider").each(function (a, b) {
                var c = jQuery(b), d = c.find(".history-slides"), e = c.find(".history-navigation");
                d.bxSlider({auto: !0, autoHover: !0, controls: !1, pager: !0, pagerCustom: e})
            })
        }, initColorbox: function () {
            jQuery(".colorbox").colorbox({maxWidth: "95%", maxHeight: "95%", rel: "gal"})
        }, setSelect: function () {
            jQuery("select[name='languages']").betaSelect({
                ...
                text: "Currency:",
                value: "USD"
            }), jQuery(".beta-select-primary").betaSelect({value: "Select", "class": "beta-select-primary"})
        }, onCart: function () {
            ...
            jQuery(".abs-fullwidth").each(function (a, b) {
                var c = jQuery(b).height(), d = jQuery(b).find("img");
            ...
            jQuery(".beta-filter-container").each(function (a, b) {
                var c = jQuery(b), d = c.find(".beta-filter a"), e = c.find(".beta-filter-body li");
                d.on("click", function () {
                    var a = jQuery(this), b = a.data("filter");
    ...
    var b = {
        init: function () {
            ...
            jQuery(".woocommerce-tabs .panel").hide(), jQuery(".woocommerce-tabs ul.tabs li a").click(function () {
                var a = jQuery(this), b = a.closest(".woocommerce-tabs");
                ...
                var a = window.location.hash, b = window.location.href, c = jQuery(this);
